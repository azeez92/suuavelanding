        ...
        <Col xs={12} lg={6}>
          ...
          <Row className="mission-contain">
            <Col xs={12} md={6} className="mission">
              <h4>Mission</h4>
              <p> To create a streamlined network for our prospects to connect, collaborate and create.</p>
            </Col>
            <Col xs={12} md={6} className="vision">
              <h4>Vision</h4>
              <p>To be the foremost go-to platform for discovering and connecting with talented African creatives, and unlocking new levels of innovation in the African fashion industry.</p>
            </Col>
          </Row>
